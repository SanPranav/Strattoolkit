...
import type { pb_OutreachEventsItem } from "@/lib/types";
...
interface EventsListProps {
  events: pb_OutreachEventsItem[] | undefined;
  selectedEvent: pb_OutreachEventsItem | null;
  onEventSelect: (event: pb_OutreachEventsItem) => void;
  onEventDeleted: () => void;
  onHoursLogged: () => void;
  isMobile?: boolean;
}
